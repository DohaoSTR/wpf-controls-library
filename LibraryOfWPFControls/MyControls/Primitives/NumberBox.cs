...
namespace ZdfFlatUI.MyControls.Primitives
{
    ...
    public class NumberBox : ComboBox
    {
        ...
        {
            get => (int)GetValue(EndNumberProperty);
        ...
        {
            get => (Thickness)GetValue(ShadowBlurProperty);
        ...
        {
            NumberBoxItem item = new NumberBoxItem();
    ...
    public class NumberBoxItem : System.Windows.Controls.ComboBoxItem
    {
        ...
        {
            object selectedItem = ((System.Windows.FrameworkElement)e.OriginalSource).DataContext;
