...
namespace ZdfFlatUI
{
    ...
    public class ZDatePicker : Control
    {
        ...
        {
            get => (EnumDatePickerType)GetValue(TypeProperty);
        ...
        {
            get => (bool)GetValue(IsShowShortCutsProperty);
        ...
        {
            get => (string)GetValue(DateStringFormatProperty);
        ...
        {
            get => (DateTime?)GetValue(SelectedDateInternalProperty);
        ...
        {
            get => (DateTime)GetValue(DisplayDateInternalProperty);
